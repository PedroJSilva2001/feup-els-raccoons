...
import pt.up.fe.els2023.utils.visitor.PreorderVisitor;

import java.util.List;

public abstract class PreorderSemanticAnalysis extends PreorderVisitor<SymbolTable, Void> implements Analysis {
    private final List<Diagnostic> errors;

    protected PreorderSemanticAnalysis() {
