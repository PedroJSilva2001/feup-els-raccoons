...
public class ColumnSum extends TableOperation{
    private final List<String> columnNames;

    public ColumnSum(List<String> columnNames) {
        this.columnNames = columnNames;
    }

    @Override
    public String getName() {
        return "ColumnSum(" + columnNames + ")";
    }
    ...
    public OperationResult execute(Table table) throws ColumnNotFoundException, ImproperTerminalOperationException {
        ...
        var sumResult = new SumOperation(columns).execute(table);
